...
On an empty stomach means that the medicine must be taken at least an hour before a meal or 2 to 3 hours after it.</p>
  ...
  <div class="column middle">
   <div class="container">
   Type of medicine:<select name="medicines"><option value="abacavir_sulfate">Abacavir</option>
 ...
 <option value="bentyl">Bentyl</option>
 <option value="cafcit">Cafcit</option>
 ...
 <option value="darvon">Darvon</option>
 <option value="edecrin">Edecrin</option>
 ...
 <option value="fastin">Fastin</option>
 <option value="gabitril">Gabitril</option>
 <option value="gardasil">Gardasali</option>
 <option value="gantanol">Gantanol</option>
 <option value="haldol">Haldol</option>
 <option value="paracetamol">Paracetamol</option>
 <option value="cetirizine">cetrizine</option>
 <option value="parnate">Parnate</option>
 <option value="tacrine">Tacrine</option>
 <option value="calpal">Calpal</option>
 </select><br><br>

MG: <input type="text" placeholder="MG" name="mg" required>
Quantity: <input type="text" placeholder="quantity" name="quantity" required>
Name : <input type="text" placeholder = "your name or emailID" name="Ename" required>
State:<input type="text" placeholder="state" name="state" required>
City:<input type="text" placeholder="city" name="city" required>
Address: <textarea rows="6" cols="60" placeholder="Current living address" name="address"></textarea>
Pincode:<input type="text" placeholder="pincode" name="pincode" required>
<label>Payment Option  Select one:</label>
...
<input type = "radio" name = "payment" value  = "netbanking"/>NETBANKING
